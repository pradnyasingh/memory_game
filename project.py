...
class gameclass(Tk):
	...
	def Label(self):
		self.Label1 = Label(self,text = "",font=("Times",30,),bg='yellow',fg="white")
		...
		self.showbutton=Button(self,text="SHOW CHARACTERS",font=("Courier",15),command=self.start_shuffle,borderwidth=0,height = 5, width = 17)
	...
	def start_shuffle(self):
		...
		if (self.number % 2)==0:
			...
			self.number_list.remove("project.py")
			...
			self.button9.place(x=630,y=280)
			self.showbutton.config(text="HIDE CHARACTERS")
			...
			self.showbutton.config(text="SHOW CHARACTERS")
			...
			self.Label1 = Label(self,text = "CARTOON CHARACTERS",font=("times",30),bg='dark blue',fg="white")
			self.Label1.place(x=274,y=400)
			...
			self.random_character_label.place(x=510,y=470)
	...
	def check(self,btnnmbr):
		if self.number_list==[]:
			messagebox.showinfo("Memeory Game", "Lets start the Game first ====> press on SHOW CHARACTERS")
			return

		elif self.random_character=="":
			messagebox.showinfo("Memeory Game", "Press on HIDE CHARACTERS")

		#print(self.number_list)
		#print(self.random_character)
		elif btnnmbr==1:
			if self.number_list[0]==self.random_character:
				messagebox.showinfo("Memeory Game", "Hurray! Its a Correct Choice")
			else:
				messagebox.showinfo("Memeory Game", "Oops! Incorrect Choice")	
		elif btnnmbr==2:
